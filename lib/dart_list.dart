...
void main() {
  ...
  */
  ...
  print(
    "Is my order NOT empty now? ${customerOrders.isNotEmpty}",
  ); // Output: true

  //6. Insert at specific position
  // Lets say the vendor wants to put a new weekly special to the menu:
  // Strawberry Choco, however the poistion it needs to be in is
  ...
  */
  ...
  // as you can see here the position for the new Item is at position [1] in our list
  // To put it BETWEEN Cappuccino [0] and Latte [2]:
  meowCafeMenu.insert(1, 'Strawberry Choco');
  // listname.insert( [Index], [Value])

  print("New Menu: $meowCafeMenu");

  //7. Insert many
  //Aditionally if you want to add multiple values inside a list you may use
  //[vla_a, val_b, val_c, ...........] into the list

  //for example: Adding List of Milk tea Variations at Index 5.

  meowCafeMenu.insertAll(5, [
    'Brown Milk Tea',
    'starry Milk Tea',
    ' Signature Milk Tea',
  ]);

  //what will we see is the item " Hot Chocolate " will still stay at the very last of the list and 'Herbal Tea' above the list of the Milk tea

  print('\nUpdated Menu$meowCafeMenu');
}
